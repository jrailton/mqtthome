...
namespace MqttHome.Mqtt.Devices
{
    public class ICCSensorData : SensorData
    {
        ...
        public ICCSensorData(MqttApplicationMessage mqtt)
        {
            ...
            switch (mqtt.Topic)
            {
                case "Inverter/AllValues":
                    ...
                    GridVoltage = float.Parse(array[1]);
                    ...
                    BatteryVoltage = float.Parse(array[7]);
                    BatterySoC = float.Parse(array[8]);
                    BatteryAmps = float.Parse(array[9]);
                    InverterFreq = float.Parse(array[10]);
                    GridFreq = float.Parse(array[11]);
                ...
                case "Inverter/AllValues2":
                    ...
                    InverterVolts = float.Parse(array[9]);
        ...
        public ICCSensorData(QpigsResponse qpigs)
        {
            GridVoltage = qpigs.GridVoltage;
            GridFreq = qpigs.GridFrequency;
            LoadWatts = qpigs.OutputWatts;
        ...
        public float? BatteryAmps { get; set; }
        ...
        public float? InverterFreq { get; set; }
        public float? InverterVolts { get; set; }
