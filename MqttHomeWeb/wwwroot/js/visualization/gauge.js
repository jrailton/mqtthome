...
(function (global, factory) {
    ...
    // START - Xah Lee's code to draw arcs
    const cos = Math.cos;
    const sin = Math.sin;
    const π = Math.PI;
    ...
    const f_svg_ellipse_arc = (([cx, cy], [rx, ry], [t1, Δ], φ) => {
        /* [
        returns a SVG path element that represent a ellipse. radians are just degrees divided by 180
    ...
    // END - Xah Lee's code to draw arcs
    ...
    var Gauge = (function () {
        ...
        function getAngle(percentage, gaugeSpanAngle) {
            return percentage / 100 * gaugeSpanAngle;
        }
        ...
        return function Gauge(elem, opts) {
            ...
            function updateGauge(theValue, frame) {
                ...
                gaugeNameElem.textContent = opts.name;
